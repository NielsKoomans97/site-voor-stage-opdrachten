<div class="wrapper headercontainer">
    <header>
        ...
        <nav>
            ...
            <a href="opdracht_3.php">Opdracht 3 - Halloween Candies</a>
            <a href="opdracht_4.php">Opdracht 4 - Roman Digits</a>
            <a href="opdracht_5.php">Opdracht 5 - JSON Treasure Find</a>
        </nav>
    </header>
</div>
